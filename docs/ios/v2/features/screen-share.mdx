...
iOS broadcast extension provides you CMSampleBuffers that you can process using HMSBroadcastExtensionSDK. This enables you to share the screen with other participants in the room in your main app that uses HMSSDK.
